  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 font-['Cairo'] dark:bg-slate-950">
      ...
      <main className="relative flex flex-1 items-center justify-center p-4 sm:p-6">
        ...
        >
          <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white/80 p-6 sm:p-8 text-center shadow-xl backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/80">
            {/* Animated Icon */}
            <motion.div
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              transition={{ delay: 0.2, duration: 0.5, type: 'spring' }}
              className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-blue-50 shadow-inner dark:bg-blue-900/20"
            >
              <motion.div
                animate={{ rotate: 360 }}
